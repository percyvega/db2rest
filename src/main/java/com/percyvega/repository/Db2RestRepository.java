...
public interface Db2RestRepository extends PagingAndSortingRepository<CarrierInquiry, Long> {
    ...
    Collection<CarrierInquiry> find(@Param("status") String status, @Param("carrierName") String carrierName, @Param("count") int count) throws DataAccessException;
